 ...
 */
{
    ...
    /* font ok too */
    style == T_AXIS ? tgif->axis_font : tgif->title_font;
               ...
               int       color      )  /* Line color (if any)  */
{
    ...
    /*
     * poly(_Color,_NumVs,_Vs, _LineStyle,_LineWidth,_PenPat,_Id,_Spline, _ObjFill,_Dash,AttrList),
     */
    static int style_list[] = { 1, 10, 7, 6, 5, 4, 3, 2 };
