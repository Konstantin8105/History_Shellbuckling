...
set case = $1
echo ""
echo "Running BIGBOSOR4: bigrestart, case: $case"
echo ""
...
echo  Executing bigrestart
#dbx -I ../dbx_sources ${BIGBOSOR4}/execute/bigrestart.${MACHINE}
#exit 99
${BIGBOSOR4}/execute/bigrestart.${MACHINE} $case >${case}.m.ERR
set stat = $status
if ($stat == 0) then
   echo  Normal termination: bigrestart
else
   echo  Abnormal termination: bigrestart
   echo  "Exit status: $stat"
   exit 2
endif
#prof -x ${BIGBOSOR4}/execute/bigrestart.${MACHINE} >! main.prof
