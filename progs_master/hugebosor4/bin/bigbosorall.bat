...
set case = $1
echo ""
echo "Running HUGEBOSOR4: bigbosorall, case: $case"
echo ""
...
#dbx -I ../dbx_sources ${HUGEBOSOR4}/execute/bigbosor4.${MACHINE}
#exit 99
${HUGEBOSOR4}/execute/bigbosor4.${MACHINE} $case >${case}.m.ERR
set stat = $status
if ($stat == 0) then
...
#prof -x ${HUGEBOSOR4}/execute/bigbosor4.${MACHINE} >! main.prof
