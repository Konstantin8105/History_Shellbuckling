...
st_init( int n ) {
  ...
  case 0:
    break;                /* f77 fixed form */

  case 1:
    st0 = stx90;          /* f90 fixed form */
    break;

  case 2:
    st0 = st90;           /* f90 free form */
    break;
...
st_is(int st) {
  ...
  if (f77fl) {
    ...
    case ST_FPP:
      if(curst == &stFPP) return 1;
      break;

    case ST_NL:
      if(curst == &stNL) return 1;
      break;

    case ST_BOS:
      if(curst == &stBOS) return 1;                
        break;

    case ST_DO:
      if(curst == &stDO) return 1;                
      break;

    case ST_ASSIGN:
      if(curst == &stASGN) return 1;                
      break;

    case ST_ASSIGNUM:
      if(curst == &stASGNex) return 1;                
      break;

    case ST_EXCEPT:
      if(curst == &stFMTex) return 1;
      break;

    case ST_TYPE:
      if(curst == &stTYPEex) return 1;
      break;

    case ST_TYPE1:
      if(curst == &stTYPE || curst == &stTYPEex1) return 1;
      break;

    case ST_RDWR:
      if(curst == &stRDWRex) return 1;
      break;

    case ST_IMPL:
      if (curst == &st90IMPLa) return 1;
      break;

    case ST_IMPL0:
      if (curst == &st90IMPL) return 1;
      break;

    case ST_NOIMPL:
      if (curst == &st90IMPLno) return 1;
      break;
    ...
    case ST_NL:
      if(curst == &stx90NL) return 1;
      break;

    case ST_BOS:
      if(curst == &stx90BOS || curst == &st90REC) return 1;
      break;
    ...
    case ST_NL:
      if(curst == &st90NL) return 1;
      break;

    case ST_BOS:
      if(curst == &st90BOS || curst == &st90BOS1) return 1;
      break;
