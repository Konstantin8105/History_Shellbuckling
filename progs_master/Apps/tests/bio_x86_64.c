...

{
     ...
     if (fstat((int)*fd, &stbuf) == -1) { /* error in status request ?    */
       ...
       if      (pri_sav > 0) {
         printf ("\n");
         printf (" BLK_STA NBInt       = %8d\n", NBInt);
         printf (" BLK_STA NBFlt       = %8d\n", NBFlt);
         printf (" BLK_STA PRU   (wds) = %8d\n", PRUSIZ/NBInt);
       ...
       if      (pri_sav > 0) {
         ...
         iarray[12] = dt.tm_mon+1;
         iarray[13] = dt.tm_mday;
         iarray[14] = dt.tm_year;
         iarray[15] = dt.tm_hour;
         iarray[16] = dt.tm_min;
         iarray[17] = dt.tm_sec;
       }
       ...
       if      (pri_sav > 0) {
         ...
         iarray[18] = dt.tm_mon+1;
         iarray[19] = dt.tm_mday;
         iarray[20] = dt.tm_year;
         iarray[21] = dt.tm_hour;
         iarray[22] = dt.tm_min;
         iarray[23] = dt.tm_sec;
       }
       ...
       if      (pri_sav > 0) {
         ...
         iarray[24] = dt.tm_mon+1;
         iarray[25] = dt.tm_mday;
         iarray[26] = dt.tm_year;
         iarray[27] = dt.tm_hour;
         iarray[28] = dt.tm_min;
         iarray[29] = dt.tm_sec;
       }
